...
(function($PS) {
  // Generated by purs version 0.13.5
  "use strict";
  $PS["EyeCandy.Button"] = $PS["EyeCandy.Button"] || {};
  var exports = $PS["EyeCandy.Button"];
  var Control_Monad_State_Class = $PS["Control.Monad.State.Class"];
  var Data_Maybe = $PS["Data.Maybe"];
...
(function($PS) {
  // Generated by purs version 0.13.5
  "use strict";
  $PS["EyeCandy.Main"] = $PS["EyeCandy.Main"] || {};
  var exports = $PS["EyeCandy.Main"];
  var Control_Bind = $PS["Control.Bind"];
  var Data_Unit = $PS["Data.Unit"];
  var Effect_Aff = $PS["Effect.Aff"];
  var Effect_Class = $PS["Effect.Class"];
  var Effect_Console = $PS["Effect.Console"];
  var EyeCandy_Button = $PS["EyeCandy.Button"];
  ...
  var main = Halogen_Aff_Util.runHalogenAff(Control_Bind.bind(Effect_Aff.bindAff)(Halogen_Aff_Util.awaitBody)(function (v) {
      return Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(Effect_Console.log("in halogen")))(function () {
          return Halogen_VDom_Driver.runUI(EyeCandy_Button.component)(Data_Unit.unit)(v);
      });
  }));
  exports["main"] = main;
})(PS);
PS["EyeCandy.Main"].main();